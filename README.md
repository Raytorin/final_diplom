...
#### В проекте присутствуют защищенные методы, для доступа к ним необходимо в http-запросе в заголовке указать Authorization со значением Token (указан *курсивом*)
#### Пример token
